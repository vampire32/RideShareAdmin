...
const RideLogs = () => {
	...
	const list = [];
	useEffect(() => {
		const databaseRef = firebase.database().ref("RideLogs/");
							...
							{TotalUsers.map((item) => {
								return (
									<tr class="bg-white border-b " key={item.key}>
										...
										<td class="px-6 py-4">{item.Usernumber}</td>
										<td class="px-6 py-4">{item.DriverID}</td>
										<td class="px-6 py-4">{item.DriverName}</td>
										<td class="px-6 py-4">{item.RideFare}</td>
										<td class="px-6 py-4">{item.WalletAmount}</td>
										<td class="px-6 py-4">{item.RideFare}</td>
									</tr>
								);
							})}
